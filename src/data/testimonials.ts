...
Amén.`,
  ...
  {
    name: "Hno. Aurelio",
    text: `Doy gracias a Dios por haberme guiado a la Iglesia Bautista Fundamental de Arizona, un lugar donde la verdad de la Palabra de Dios es predicada con claridad, firmeza y amor. Desde que llegué, he sido bendecido por el liderazgo fiel del Pastor Roberto Goins, un siervo comprometido con Dios y con su iglesia.
...
¡A Dios sea la gloria por lo que Él está haciendo en la Iglesia Bautista Fundamental de Casa Grande, Arizona.`,
  ...
  },
  {
    ...
    text: `Llegamos a la Iglesia Bíblica Bautista Fundamental de Arizona en un momento en que nuestras vidas estaban llenas de dudas, luchas y heridas del pasado. No sabíamos que Dios ya tenía un plan perfecto para transformarnos. Desde el primer día, fuimos recibidos con amor genuino, con la verdad de Su Palabra y con una comunidad que nos abrazó como familia.
